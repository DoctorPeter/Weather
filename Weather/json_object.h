...
#undef FALSE
#define FALSE ((_bool_)0)

#undef TRUE
#define TRUE ((_bool_)1)
 ...
 * @param b a _bool_ TRUE or FALSE (0 or 1)
 * @returns a json_object of type json_type_boolean
 */
extern struct json_object* json_object_new_boolean(_bool_ b);

/** Get the _bool_ value of a json_object
 *
 * The type is coerced to a _bool_ if the passed object is not a _bool_.
 ...
 * @returns a _bool_
 */
extern _bool_ json_object_get_boolean(struct json_object *obj);
